...
DEFAULT_GROK = {
    ...
    "retry_status_codes": [401, 429],  # 可重试的HTTP status码
}
...
DEFAULT_GLOBAL = {
    ...
    "batch_save_interval": 1.0,  # 批量Saving间隔（s）
    "batch_save_threshold": 10  # 触发批量Saving的变更数阈值
}
...
class ConfigManager:
    ...
    def load(self, section: Literal["global", "grok"]) -> Dict[str, Any]:
        ...
        try:
            ...
            raise Exception(f"[Setting] 配置Failed to load: {e}") from e
