...
class FileStorage(BaseStorage):
    ...
    async def init_db(self) -> None:
        ...
        if not self.token_file.exists():
            ...
            logger.info("[Storage] Creating token file")
        ...
        if not self.config_file.exists():
            ...
            logger.info("[Storage] Creating config file")
    ...
    async def _load_json(self, path: Path, default: Dict, lock: asyncio.Lock) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"[Storage] Loading{path.name}Failed: {e}")
            return default
    ...
    async def _save_json(self, path: Path, data: Dict, lock: asyncio.Lock) -> None:
        ...
        try:
            ...
            logger.error(f"[Storage] Saving{path.name}Failed: {e}")
            raise
...
class MysqlStorage(BaseStorage):
    ...
    async def _load_db(self, table: str) -> Optional[Dict]:
        ...
        try:
            ...
            logger.error(f"[Storage] Loading{table}Failed: {e}")
            return None
    ...
    async def _save_db(self, table: str, data: Dict) -> None:
        ...
        try:
            ...
            logger.error(f"[Storage] Saving{table}Failed: {e}")
            raise
...
class RedisStorage(BaseStorage):
    ...
    async def init_db(self) -> None:
        ...
        try:
            ...
            logger.info(f"[Storage] Redis connected successfully")
    ...
    async def _save_redis(self, key: str, data: Dict) -> None:
        ...
        try:
            ...
            logger.error(f"[Storage] SavingRedisFailed: {e}")
            raise
...
class StorageManager:
    ...
    async def init(self) -> None:
        ...
        if mode in ("mysql", "redis") and not url:
            raise ValueError(f"{mode.upper()}mode需要DATABASE_URL")
